        ...
        <b-table-column label="Action" centered>
          <span>
            <b-button 
                type="is-text" 
                tag="router-link"
                :to="'/owner/form-ukuran-hewan/' + props.row.id_ukuran"
                rounded>
                  <b-icon icon="pencil" type="is-info"></b-icon>
            </b-button>
            <b-button 
                type="is-text" 
                @click="confirmDelete(props.row.id_ukuran)" 
                rounded>
...
export default {
  ...
  methods: {
    ...
    // },
    deleteData(deleteId) {
      var uri = this.$api_baseUrl + "ukuranhewan/delete/" + deleteId;
    ...
    confirmDelete(deleteId) { // Buat ngeluarin modal box konfirmasi delete
      this.$buefy.dialog.confirm({
        title: 'Hapus Data Ukuran Hewan',
        message: 'Apa anda yakin ingin <b>menghapus</b> ukuran hewan ini?',
        confirmText: 'Hapus',
        cancelText: 'Batal',
        type: 'is-danger',
        hasIcon: true,
